								...
								<?}else{?>
									<div class="offer_buy_block" data-tovar="<?=$arItem["ID"];?>">
										<div class="counter_wrapp clearfix">
											...
											<div class="counter_block big" data-item="<?=$arItem["ID"];?>">
