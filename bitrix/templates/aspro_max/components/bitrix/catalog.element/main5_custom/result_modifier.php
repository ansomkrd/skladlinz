...
foreach($arResult["OFFERS"] as $idOffer=>$arOffer)
	{		
		$arSkuTmp = array();
		if ($offerPropsExists)
		{
			...
			if ((!is_array($arIblockOfferProps) || empty($arIblockOfferProps))){
		...
		if($arSkuTmp["CAN_BUY"]) $arSku[] = $arSkuTmp;
	}
