      ...
      (BX.Sale.OrderAjaxComponent = {
        ...
        getDeliveryCompactInfo: function () {
          ...
          if (currentDelivery) {
            ...
            const $zipProp =
              this.deliveryBlockNode.querySelector("#zipProperty");
            if ($zipProp) {
        ...
        editActivePropsBlock: function (activeNodeMode) {
          ...
          this.opened[this.propsBlockNode.id] &&
            ...
            this.result.USER_PROFILES || !this.result.IS_AUTHORIZED
              ? this.showFirstProps()
              : setTimeout(
                  BX.delegate(function () {
                    this.showFirstProps();
        ...
        alterDateProperty: function (settings, inputText) {
          ...
          parentNode.querySelector("input[type=text]").style.cursor = "pointer";
              ...
              BX.delegate(function (e) {
                ...
                BX.calendar({
                  ...
                  callback_after: function (e) {
                    var dateMas = self.date.split(".");
                    var datestart = Date.parse(
                      dateMas[2] +
                        "-" +
                        dateMas[1] +
                        "-" +
                ...
                $(".bx-calendar-header a").click(function () {
                  self.blockDates();
                  $(".bx-calendar-month-popup span").click(function () {
                    setTimeout(function () {
                      self.blockDates();
                    }, 10);
                  });
                  $(".bx-calendar-year-content span").click(function () {
                    setTimeout(function () {
                      self.blockDates();
                    }, 10);
                  });
          ...
          BX.bind(
            parentNode.querySelector("input[type=text]"),
            "click",
            BX.delegate(function (e) {
              var target = e.target || e.srcElement,
                parentNode = BX.findParent(target, {
        ...
        blockDates: function () {
          ...
          var dateMas = self.date.split(".");
          var datestart = Date.parse(
            dateMas[2] + "-" + dateMas[1] + "-" + dateMas[0] + "T00:00:00+00:00"
          );
        ...
        isValidRegionBlock: function () {
          ...
          return (regionErrors = regionErrors.concat(
        ...
        validatePhone: function (input, arProperty, fieldName) {
          ...
          if (
            ...
            "Y" == arProperty.IS_PHONE && value.length > 0)
          ) {
        ...
        showTotalDeliveryInfo: function () {
          ...
          if (
            ...
            const removeChild = tempDiv.querySelectorAll(
              "select, input, button, iframe, a, br, hr, img"
            );
            if (removeChild) {
